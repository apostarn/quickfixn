...
public static class Tags
{
    ...
    public const int TradeNum = 5001;
    public const int OrderNum = 5002;
    public const int AccruedCoupon = 5003;
    public const int ExValue = 5004;
    public const int ExUserID = 5005;
    public const int ClearingCommission = 5008;
    public const int TradingCommission = 5009;
    public const int ServiceCommission = 5010;
    public const int RepoValue = 5011;
    public const int UserID = 5015;
    public const int StationID = 5016;
    public const int TradeTimeGMT = 5017;
    public const int FirmId = 5018;
    public const int RepoStartDiscount = 5019;
    public const int RepoLowerDiscount = 5020;
    public const int RepoUpperDiscount = 5021;
    public const int ExchangeTradeID = 5022;
    public const int PosUpdateAction = 5024;
    public const int NoPosKeys = 5025;
    public const int PosKeyType = 5026;
    public const int PosKeyValue = 5027;
    public const int NoPosItems = 5028;
    public const int PosItemType = 5029;
    public const int PosItemValue = 5030;
    public const int Collateral = 5038;
    public const int CollateralBuy = 5039;
    public const int CollateralSell = 5040;
    public const int BaseAsset = 5041;
    public const int BaseAssetClass = 5042;
    public const int FaceValue = 5043;
    public const int CouponValue = 5044;
    public const int AccruedInt = 5045;
    public const int BuyBackPrice = 5046;
    public const int BuyBackDate = 5047;
    public const int NextCouponDate = 5048;
    public const int CouponPeriod = 5049;
    public const int YestMarketPrice = 5050;
    public const int SettlCurrFxRateSide = 5058;
    public const int NetTradePrice = 5059;
    public const int ExchangeOrderID = 5066;
    public const int NoOtcPostTradeIndicators = 5067;
    public const int OtcPostTradeIndicator = 5068;
    public const int QtyScale = 5073;
    public const int RefOrderPrice = 5075;
    public const int CancelStopIfRefOrderPartiallyFilled = 5076;
    public const int StopPxCondition = 5077;
    public const int RefSecurityID = 5078;
    public const int RefExDestination = 5079;
    public const int TakeProfitPx = 5080;
    public const int StartTime = 5083;
    public const int EndTime = 5084;
    public const int RegNumber = 5090;
    public const int RefundRate = 5141;
    public const int TotalValueTraded = 6143;
    public const int MarketLot = 6200;
    public const int MarketSegmentSymbol = 7177;
    public const int TradingSystemTicketNumber = 9009;
    public const int BLPTicketType = 9654;
    public const int PricingNo = 9896;
    public const int UserText = 9906;
